...
const contentMap = {
  'Experiencia laboral': {
    ...
    left: [
      { imagen: "../public/image/icons/indra.webp", 
        description: 'Madrid, España',
        fecha: "20/03/2023 – 11/06/2024",
        alt: 'Indra Logo',
        title: 'Indra',
      },
      { imagen: "../public/image/icons/infibail.webp", 
        description: 'Madrid, España',
  ...
  left: [
    { imagen: "../public/image/icons/UEM.webp", 
      description: 'Madrid, España',
      fecha: "18/09/2023 – 21/06/2024",
      alt: 'UEM Logo',
      title: 'UEM',
    },
    { imagen: "../public/image/icons/SMA.webp", 
      description: 'Madrid, España',
      fecha: "18/09/2020 – 21/06/2022",
      alt: 'SMA logo',
      title: 'SMA',
    },
    { imagen: "../public/image/icons/SAE.webp", 
      description: 'Madrid, España',
      fecha: "12/09/2016 – 20/06/2017",
      alt: 'SAE logo',
      title: 'SAE',
    },
    { imagen: "../public/image/icons/ART.webp", 
      description: 'Madrid, España',
  ...
  'Cursos': {
    ...
    left: [
      { imagen: "../public/image/icons/hardvard.webp", 
        description: 'Madrid, España',
        fecha: "19/05/2024 – Actualmente",
        alt: 'hardvar Logo',
        title: 'HRV',
      },
      { imagen: "../public/image/icons/cisco.webp", 
        description: 'Madrid, España',
        fecha: "19/05/2024 – Actualmente",
        alt: 'hardvar Logo',
        title: 'CISCO',
  ...
  'Proyectos': {
    ...
    left: [
      { 
        imagen: "../public/image/icons/maraboo.webp", 
      ...
      { 
        imagen: "../public/image/icons/PP.webp", 
      ...
      { 
        imagen: "../public/image/icons/hamitiNews.webp", 
      ...
      { 
        imagen: "../public/image/icons/FNC.webp", 
  ...
  'Aptitudes': {
    ...
    left: [
      { 
        imagen: "../public/image/icons/FRONT.webp", 
        alt: 'FNC Logo',
        title: 'FRONT',
      },
      { 
        imagen: "../public/image/icons/BACK.webp", 
        alt: 'FNC Logo',
        title: 'BACK',
      },
      { 
        imagen: "../public/image/icons/SO.webp", 
        alt: 'FNC Logo',
        title: 'SO',
      },
      { 
        imagen: "../public/image/icons/MS.webp", 
        alt: 'FNC Logo',
        title: 'MS',
      },
